...
use um::shellapi::{
    SEE_MASK_ASYNCOK, SEE_MASK_FLAG_LOG_USAGE, SEE_MASK_FLAG_NO_UI, SEE_MASK_HOTKEY, SEE_MASK_ICON,
    SEE_MASK_NOASYNC, SEE_MASK_NOZONECHECKS, SEE_MASK_NO_CONSOLE, SEE_MASK_UNICODE
};
use um::shtypes::{
    PCUIDLIST_RELATIVE, PCUITEMID_CHILD, PCUITEMID_CHILD_ARRAY, PIDLIST_RELATIVE, PITEMID_CHILD,
    SHCOLSTATEF, SHCOLUMNID, SHELLDETAILS, STRRET
};
...
// pub const CMDSTR_NEWFOLDERW = L"NewFolder";
// pub const CMDSTR_VIEWLISTW = L"ViewList";
// pub const CMDSTR_VIEWDETAILSW = L"ViewDetails";
pub const CMIC_MASK_HOTKEY: DWORD = SEE_MASK_HOTKEY;
pub const CMIC_MASK_ICON: DWORD = SEE_MASK_ICON;
pub const CMIC_MASK_FLAG_NO_UI: DWORD = SEE_MASK_FLAG_NO_UI;
pub const CMIC_MASK_UNICODE: DWORD = SEE_MASK_UNICODE;
pub const CMIC_MASK_NO_CONSOLE: DWORD = SEE_MASK_NO_CONSOLE;
//`SEE_MASK_FLAG_SEPVDM` is not defined in Win SDK 10.0.18362.0
//pub const CMIC_MASK_FLAG_SEP_VDM: DWORD = SEE_MASK_FLAG_SEPVDM;
pub const CMIC_MASK_ASYNCOK: DWORD = SEE_MASK_ASYNCOK;
pub const CMIC_MASK_NOASYNC: DWORD = SEE_MASK_NOASYNC;
pub const CMIC_MASK_SHIFT_DOWN: DWORD = 0x10000000;
pub const CMIC_MASK_CONTROL_DOWN: DWORD = 0x40000000;
pub const CMIC_MASK_FLAG_LOG_USAGE: DWORD = SEE_MASK_FLAG_LOG_USAGE;
pub const CMIC_MASK_NOZONECHECKS: DWORD = SEE_MASK_NOZONECHECKS;
pub const CMIC_MASK_PTINVOKE: DWORD = 0x20000000;
